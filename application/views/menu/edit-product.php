        ...
        <div class="col-lg">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="number" class="form-control" name="unit_price" placeholder="Unit price" value="<?= $product['unit_price'] ?>">
                    <?= form_error('unit_price', '<small class="text-danger pl-3">', '</small>') ?>
                </div>
                <div class="form-group col-md-6">
                    <label for="bukalapak">Bukalapak</label>
                    <input type="text" class="form-control" name="bukalapak" placeholder="Bukalapak URL" value="<?= $product['bukalapak'] ?>">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="tokopedia">Tokopedia</label>
                    <input type="text" class="form-control" name="tokopedia" placeholder="Tokopedia URL" value="<?= $product['tokopedia'] ?>">
                </div>
                <div class="form-group col-md-6">
                    <label for="olx">OLX</label>
                    <input type="text" class="form-control" name="olx" placeholder="OLX URL" value="<?= $product['olx'] ?>">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md">
                    <label for="description">Description</label>
                    <input type="text" class="form-control" name="description" placeholder="Description text" value="<?= $product['description'] ?>">
                </div>
            </div>
            <div>
